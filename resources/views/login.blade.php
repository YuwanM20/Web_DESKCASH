...
<body class="" style="background: #081225;">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-900 mb-4" style="color: #081226;">Login</h1>
                                    </div>
                                ...
                                @enderror
                                        ...
                                        <button class="btn btn-user text-white btn-block" type="submit" style="background: #081226;">
                                            Login
                                        </button>
                                    </form>
                                    <hr>
                                    <div class="text-center " >
                                        <a class="medium" style="color: #081226;" href="{{ route('register') }}">Buat Akun</a>
                                    </div>
                                </div>
                            </div>
                        </div>
